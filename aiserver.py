...
cpm1list = [
    ["CPM-1 Small", "cpm1-small", "6GB"],
    ["CPM-1 Large", "cpm1-large", "24GB"],
    ["Return to Main Menu", "Return", ""],
    ]
...
class vars:
    ...
    badwordsids = [[58], [60], [50256]] # For Wenzhong GPT2
    ...
    badwordsids_cpm1 = [[0], [1], [3], [4], [5], [6], [7], [183], [184]]
    badwordsids_bloom_zh = [[0], [1], [2], [3], [62], [64]]
...
if(vars.model not in ["InferKit", "Colab", "OAI", "GooseAI" , "ReadOnly", "TPUMeshTransformerGPTJ", "TPUMeshTransformerGPTNeoX"]):
    ...
    if(vars.model_type == "bloom"):
        vars.badwordsids = vars.badwordsids_bloom_zh # For bloom-zh
